...
Public Class frmReportGenerator
    ...
    Public Sub LoadTemplate()
        LoadXgridLookupSearch("SELECT rptid,rptname as 'Report Template',datequery,usedateasof from tblreporttemplate where status=1 order by rptname asc", "tblreporttemplate", txtReportTemplate, GridOffice, Me)
        GridOffice.Columns("rptid").Visible = False
        GridOffice.Columns("datequery").Visible = False
        GridOffice.Columns("usedateasof").Visible = False
    End Sub
    Private Sub txtReportTemplate_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtReportTemplate.EditValueChanged
        ...
        If txtReportTemplate.Properties.View.GetFocusedRowCellValue("datequery") = True Then
            If txtReportTemplate.Properties.View.GetFocusedRowCellValue("usedateasof") = True Then
    ...
    Public Sub printreportFormated()
        ...
        ElseIf txtpapertype.Text = "Legal" Then
        ...
        If txtReportTemplate.Properties.View.GetFocusedRowCellValue("datequery") = True Then
            Dim dfrm As Date = date_from.Text
            Dim dto As Date = date_to.Text
            If date_from.Enabled = False Then
                report.txttitle.Text = txtReportTemplate.Text & " (as of " & Format(dto, "MMMM dd, yyyy") & ")"
            Else
                report.txttitle.Text = txtReportTemplate.Text & " (" & Format(dfrm, "MMMM dd, yyyy") & " - " & Format(dto, "MMMM dd, yyyy") & ")"
            End If
        Else
            report.txttitle.Text = txtReportTemplate.Text
        End If
        report.Name = LCase(txtReportTemplate.Text)
    ...
    End Sub
    Public Sub printreportUnFormated()
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        If ckClearReport.Checked = True Then
            printreportUnFormated()
        Else
            printreportFormated()
        End If
    End Sub
