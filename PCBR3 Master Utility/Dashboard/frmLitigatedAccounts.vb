...
Public Class frmLitigatedAccounts
    ...
    Public Sub filter()
        ...
        LoadXgrid("SELECT id, refcode as 'Reference No.', " _
                        ...
                        + " FROM tbldelinquentlist where status = 'LITIGATED' and accstatus=1" _
    ...
    Private Sub GridView1_RowCellStyle(ByVal sender As Object, ByVal e As RowCellStyleEventArgs) Handles gridview1.RowCellStyle
        If CheckEdit1.Checked = True Then
            ...
            ElseIf Val(days) = 0 Then
                ...
                e.Appearance.ForeColor = Color.Black
            ElseIf Val(days) < 0 Then
                'e.Appearance.Font = New Font("Tahoma", 8.25, FontStyle.Strikeout)
