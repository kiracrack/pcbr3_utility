...
Public Class frmAccountsHistory
    ...
    Private Sub RemoveItemToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RemoveItemToolStripMenuItem.Click
        If CheckSelectedRow("Reference No.", gridview1) = True Then
            ...
            frmDelinquentAccountInfo.accstatus.Text = "close"
            frmDelinquentAccountInfo.BarButtonItem2.PerformClick()
        End If
    End Sub
    ...
    Private Sub CloseAccountToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If CheckSelectedRow("Reference No.", gridview1) = True Then
